...
//	public List<AudioClip> warning_Clips = new List<AudioClip>();
    ...
    private Vector3[] mainCameraPos = new Vector3[] { new Vector3(0, 0f, -100f), new Vector3(266f, 0f, -100f) };
	...
	protected void InitializeAudio()
    {
        ...
        if (audioEffect == null) {
			...
			if(audioEffect_Obj) {
				...
				audioEffect_Obj = Instantiate(Resources.Load(ResourcePathManager.PATH_OF_AUDIO_OBJECTS + "AudioEffect", typeof(GameObject))) as GameObject;
