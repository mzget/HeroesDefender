...
//		Handheld.PlayFullScreenMovie("Movies/LogoVista3D.mp4", Color.white, FullScreenMovieControlMode.Hidden, FullScreenMovieScalingMode.AspectFit);
		...
		if(Application.isLoadingLevel == false) {
			Application.LoadLevel(Mz_BaseScene.ScenesInstance.WaitForStart.ToString());
		}
	}
	...
	protected override void Initialization ()
	{
		...
		ExtendSaveManager.Language_id = PlayerPrefs.GetInt(ExtendSaveManager.KEY_SYSTEM_LANGUAGE, 0);
		Main.Mz_AppLanguage.appLanguage = (Main.Mz_AppLanguage.SupportLanguage)ExtendSaveManager.Language_id;
	}
